...
<body>
    ...
    $stmt = $pdo->prepare('SELECT * FROM TbProducts WHERE DeletedAt is null and (Name like "%" :srch or IdProduct like "%" :srch or Category like "%" :srch)');
                        ...
                        <tr>
                            ...
                            <th class="table-tools">
                                <div class="input-group ">
                                    <a class="btn btn-outline-secondary" type="button" href="edit.php?id=<?= $product['IdProduct'] ?>"><i class="bi bi-wrench"></i></a>
                                    <a class="btn btn-outline-danger" type="button" href="delete.php?id=<?= $product['IdProduct'] ?>"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </th>
                        </tr>
                    <?php endforeach; ?>
