...
<body>
    ...
    $stmt = $pdo->prepare('SELECT * FROM TbEmployees WHERE DeletedAt is null and (Name like "%" :srch or Surname like "%" :srch or IdEmployee like "%" :srch or Job like "%" :srch or Mail like "%" :srch)');
                        ...
                        <tr>
                            ...
                            <th class="table-tools">
                                <div class="input-group ">
                                    <a class="btn btn-outline-secondary" type="button" href="edit.php?id=<?= $employee['IdEmployee'] ?>"><i class="bi bi-wrench"></i></a>
                                    <a class="btn btn-outline-danger" type="button" href="delete.php?id=<?= $employee['IdEmployee'] ?>"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </th>
                        </tr>
                    <?php endforeach; ?>
